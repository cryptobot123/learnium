...
RESOURCES += src/qt/learnium.qrc src/qt/learnium_locale.qrc

TRANSLATIONS += src/qt/locale/learnium_bg.ts \
                src/qt/locale/learnium_de.ts \
                src/qt/locale/learnium_en.ts \
                src/qt/locale/learnium_es.ts \
                src/qt/locale/learnium_fi.ts \
                src/qt/locale/learnium_fr.ts \
                src/qt/locale/learnium_it.ts \
                src/qt/locale/learnium_ja.ts \
                src/qt/locale/learnium_pl.ts \
                src/qt/locale/learnium_pt.ts \
                src/qt/locale/learnium_ru.ts \
                src/qt/locale/learnium_sk.ts \
                src/qt/locale/learnium_sv.ts \
                src/qt/locale/learnium_vi.ts \
                src/qt/locale/learnium_zh_CN.ts \
                src/qt/locale/learnium_zh_TW.ts
