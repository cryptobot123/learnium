...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Learnium server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Learnium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Learnium features */
        {"learnium", "listmasternodes", &listmasternodes, true, true, false},
        {"learnium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"learnium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"learnium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"learnium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"learnium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"learnium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"learnium", "masternodedebug", &masternodedebug, true, true, false},
        {"learnium", "startmasternode", &startmasternode, true, true, false},
        {"learnium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"learnium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"learnium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"learnium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"learnium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"learnium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"learnium", "preparebudget", &preparebudget, true, true, false},
        {"learnium", "submitbudget", &submitbudget, true, true, false},
        {"learnium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"learnium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"learnium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"learnium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"learnium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"learnium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"learnium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"learnium", "checkbudgets", &checkbudgets, true, true, false},
        {"learnium", "mnsync", &mnsync, true, true, false},
        {"learnium", "spork", &spork, true, true, false},
        {"learnium", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> learnium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37513/\n";
}
