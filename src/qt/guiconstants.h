...
/* Learnium GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Learnium"
#define QAPP_ORG_DOMAIN "learnium.org"
#define QAPP_APP_NAME_DEFAULT "Learnium-Qt"
#define QAPP_APP_NAME_TESTNET "Learnium-Qt-testnet"
