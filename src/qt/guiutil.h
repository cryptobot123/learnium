...
/** Utility functions used by the Learnium Qt UI.
 */
namespace GUIUtil
{
...
// Render Learnium addresses in monospace font
...
// Parse "learnium:" URI into recipient object, return true on successful parsing
