...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(LRA);
    unitlist.append(mLRA);
    unitlist.append(uLRA);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case LRA:
        return QString("learnium");
    case mLRA:
        return QString("mlearnium");
    case uLRA:
        return QString::fromUtf8("ulearnium");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LRA:
            return QString("tLRA");
        case mLRA:
            return QString("mtLRA");
        case uLRA:
            return QString::fromUtf8("μtLRA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LRA:
            return QString("LRA");
        case mLRA:
            return QString("Milli-LRA (1 / 1" THIN_SP_UTF8 "000)");
        case uLRA:
            return QString("Micro-LRA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case LRA:
            return QString("TestLRAs");
        case mLRA:
            return QString("Milli-TestLRA (1 / 1" THIN_SP_UTF8 "000)");
        case uLRA:
            return QString("Micro-TestLRA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
