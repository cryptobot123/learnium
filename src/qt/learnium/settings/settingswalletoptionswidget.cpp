...
#include "qt/learnium/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/learnium/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(LearniumGUI* _window, QWidget *parent) :
