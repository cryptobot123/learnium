...
#include "qt/learnium/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(LearniumGUI* _window, QWidget *parent) :
