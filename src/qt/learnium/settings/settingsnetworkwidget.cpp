...
#include "qt/learnium/settings/settingsnetworkwidget.h"
#include "qt/learnium/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/learnium/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(LearniumGUI* _window, QWidget *parent) :
