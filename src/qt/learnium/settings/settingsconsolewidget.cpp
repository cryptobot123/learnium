...
#include "qt/learnium/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/learnium/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(LearniumGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the Learnium RPC console.") + "<br>" +
