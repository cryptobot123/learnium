...
#include "qt/learnium/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/learnium/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(LearniumGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to LearniumGUI::handleRestart()
