...
#include "qt/learnium/furabstractlistitemdelegate.h"
#include "qt/learnium/txviewholder.h"
#include "qt/learnium/tooltipmenu.h"
#include "qt/learnium/sendmultirow.h"
#include "qt/learnium/coldstakingmodel.h"
#include "qt/learnium/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(LearniumGUI* parent);
    ~ColdStakingWidget();
