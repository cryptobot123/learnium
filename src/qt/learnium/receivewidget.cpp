...
#include "qt/learnium/forms/ui_receivewidget.h"
...
#include "qt/learnium/addressholder.h"
...
ReceiveWidget::ReceiveWidget(LearniumGUI* parent) :
	PWidget(parent),
	ui(new Ui::ReceiveWidget)
{
	...
	ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive LRA."));
