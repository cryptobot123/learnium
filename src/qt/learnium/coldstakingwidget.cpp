...
#include "qt/learnium/coldstakingwidget.h"
#include "qt/learnium/forms/ui_coldstakingwidget.h"
#include "qt/learnium/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/learnium/requestdialog.h"
#include "qt/learnium/tooltipmenu.h"
#include "qt/learnium/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(LearniumGUI* parent) :
    PWidget(parent),
	...
	isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your LRAs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept LRA delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select LRA outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 LRA" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
