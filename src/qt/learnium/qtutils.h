...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, LearniumGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, LearniumGUI *gui, double posX = 3);
