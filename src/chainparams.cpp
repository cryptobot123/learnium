...
(0, uint256("0x0000044697856d823ab7b6db9c83d1513fd8eca4b72287072b5934f353eeced6"))
(5, uint256("0x00000865bb4875970d7f2244b39dcbd6318dc563233634df22bf3f1b6f62105f"))
;
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 37512;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Learnium starting difficulty is 1 / 2^12
        ...
        nBlockZerocoinV2 = 10035; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Learnium mainnet Launch";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1602215981;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 123681;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000044697856d823ab7b6db9c83d1513fd8eca4b72287072b5934f353eeced6"));
        assert(genesis.hashMerkleRoot == uint256("0x2bce0d0f55dd022b0e0931a037fca1e4ecab887bba99b7eac313da15fc3638e5"));


        vSeeds.push_back(CDNSSeedData("206.166.251.201","206.166.251.201"));
        vSeeds.push_back(CDNSSeedData("206.166.251.159","206.166.251.159"));
        vSeeds.push_back(CDNSSeedData("172.86.75.193","172.86.75.193"));
        vSeeds.push_back(CDNSSeedData("45.61.139.79","45.61.139.79"));
        vSeeds.push_back(CDNSSeedData("206.166.251.95","206.166.251.95"));
        vSeeds.push_back(CDNSSeedData("206.166.251.148","206.166.251.148"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 13);
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 110);     // starting with 'L'
        ...
        strSporkPubKey = "02d32cda9fc44ee1368e4d609a0ec721651942e1ab337698d040ea4057d2aa867f";
        strSporkPubKeyOld = "02d32cda9fc44ee1368e4d609a0ec721651942e1ab337698d040ea4057d2aa867f";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zlra to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "learnium-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "learnium-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.learnium.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet learnium addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet learnium script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet learnium BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet learnium BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet learnium BIP44 coin type is '1' (All coin's testnet default)
