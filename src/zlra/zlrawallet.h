...
#ifndef Learnium_ZLRAWALLET_H
#define Learnium_ZLRAWALLET_H
...
public:
    CzLRAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLRA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLRA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
