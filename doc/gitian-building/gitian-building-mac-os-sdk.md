...
The script [extract-osx-sdk.sh](https://github.com/learnium-project/learnium/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
learnium/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/learnium-project/learnium/blob/master/doc/README_osx.md) for troubleshooting tips.
