...
The build script we'll be using is contained in the Learnium github repository ([contrib/gitian-build.py](https://github.com/learnium-project/learnium/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Learnium repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Learnium-Project/Learnium/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, learnium-detached-sigs, and learnium GitHub repos.
