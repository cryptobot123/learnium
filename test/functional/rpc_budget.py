...
class BudgetProposalTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Learnium address")
        assert_raises_rpc_error(-5, "Invalid Learnium address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 LRA allowed", self.nodes[0].preparebudget,
