...
from test_framework.learnium_node import LearniumTestNode
...
class Learnium_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(LearniumTestNode())
