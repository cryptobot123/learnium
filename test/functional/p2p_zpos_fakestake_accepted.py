...
from fake_stake.base_test import Learnium_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(Learnium_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zlrastake']] * self.num_nodes
