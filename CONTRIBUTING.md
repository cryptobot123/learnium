Contributing to Learnium
============================

The Learnium project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/learnium-project/learnium/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Learnium project, and is not to be
confused with overall Learnium Network Protocol consensus changes.

Whether a pull request is merged into Learnium rests with the project merge
...
Patches that change Learnium consensus rules are considerably more involved than
...
Where a patchset proposes to change the Learnium consensus, it must have been
...
The project leader is the release manager for each Learnium release.
